...
export const DOCS_INDEX: DocsIndexEntry[] = [
  ...
  { kind: "page", title: "Integrations (Composio)", description: "77 managed-auth providers: Gmail, Slack, GitHub, Notion...", url: "/docs/integrations" },
  ...
  { kind: "section", title: "Composio usage in Python", description: "ComposioToolSet: connection ID as env var", url: "/docs/integrations#use" },

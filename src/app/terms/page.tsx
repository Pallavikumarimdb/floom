...
const TOC_ITEMS = [
  ...
  { id: "your-account", label: "2. Your account" },
  { id: "acceptable-use", label: "3. Acceptable use" },
  { id: "your-content", label: "4. Your content" },
      ...
      <div className="mx-auto max-w-6xl px-5 py-14">
        <div className="flex gap-14">
          ...
          >
            ...
            {/* ── 1. Eligibility ── */}
            <section id="eligibility" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
            ...
            {/* ── 2. Account ── */}
            <section id="your-account" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                2. Your account
              </h2>
              <p style={{ color: "var(--muted)" }}>
            ...
            {/* ── 3. Acceptable use ── */}
            <section id="acceptable-use" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                3. Acceptable use
              </h2>
            ...
            {/* ── 4. Your content ── */}
            <section id="your-content" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                4. Your content
              </h2>
              <p style={{ color: "var(--muted)" }}>
            ...
            <section id="intellectual-property" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                5. Intellectual property
              </h2>
              <p style={{ color: "var(--muted)" }}>
            ...
            <section id="third-party" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                6. Third-party services
              </h2>
              <p style={{ color: "var(--muted)" }}>
            ...
            {/* ── 7. Disclaimers ── */}
            <section id="disclaimers" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
            ...
            <section id="liability" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                8. Limitation of liability
              </h2>
              <p style={{ color: "var(--muted)" }}>
            ...
            {/* ── 9. Indemnification ── */}
            <section id="indemnification" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                9. Indemnification
              </h2>
              <p style={{ color: "var(--muted)" }}>
            ...
            {/* ── 10. Termination ── */}
            <section id="termination" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                10. Termination
              </h2>
              <p style={{ color: "var(--muted)" }}>
            ...
            {/* ── 11. Changes ── */}
            <section id="changes" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
            ...
            {/* ── 12. Governing law ── */}
            <section id="governing-law" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                12. Governing law
              </h2>
              <p style={{ color: "var(--muted)" }}>
            ...
            {/* ── 13. Contact ── */}
            <section id="contact" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                13. Contact
              </h2>
              <p style={{ color: "var(--muted)" }}>

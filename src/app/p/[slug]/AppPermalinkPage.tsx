    ...
    >
      <div style={{ minWidth: 0, flex: 1 }}>
        ...
        >
          ...
          <span><strong>Floom is in public beta</strong> {": app secrets are encrypted at rest and injected only at runtime. Use sandboxed or revocable credentials while the beta hardening window is open."}</span>
        </div>
      </div>

...
const TOC_ITEMS = [
  ...
  { id: "service-providers", label: "4. Service providers" },
  { id: "ccpa", label: "5. California consumer rights" },
  { id: "data-access", label: "6. Data access and deletion" },
      ...
      <div className="mx-auto max-w-6xl px-5 py-14">
        <div className="flex gap-14">
          ...
          >
            ...
            {/* ── 1. Controller ── */}
            <section id="who-we-are" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
            ...
            {/* ── 2. Data collected ── */}
            <section id="information-we-collect" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
            ...
            <section id="how-we-use" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
            ...
            {/* ── 4. Sub-processors ── */}
            <section id="service-providers" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "16px" }}>
                4. Service providers
              </h2>
              <p style={{ marginBottom: "16px", color: "var(--muted)" }}>
            ...
            {/* ── 5. CCPA ── */}
            <section id="ccpa" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
            ...
            {/* ── 6. Your rights ── */}
            <section id="data-access" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
            ...
            {/* ── 7. Cookies ── */}
            <section id="cookies" style={{ borderTop: "1px solid var(--line)", paddingTop: "32px", marginTop: "32px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "12px" }}>
                7. Cookies
              </h2>
              <p style={{ color: "var(--muted)" }}>

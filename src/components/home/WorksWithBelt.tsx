 ...
 *      text when a logo doesn't exist".
 *
...
// SimpleIcons Cursor mark (real brand path, viewBox 0 0 24 24).
const CursorMark = (
  <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true">
...
// MCP has no finalised public logo. Use a neutral protocol-ring glyph.
const McpMark = (
